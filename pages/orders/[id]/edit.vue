      ...
      <div class="step_block fourth">
        ...
        <div class="right_part">
          ...
          <div
            class="input_block"
            v-if="
              newOrder.price_type === 'fixed' ||
              newOrder.price_type === 'contract'
            "
          >
          ...
          <div
            class="input_block_wrapper"
            v-else-if="newOrder.price_type === 'hourly'"
          >
            <div class="input_block">
              <p>Цена для вашего заказа</p>
              <OrdersPriceInput
                v-model="newOrder.price.from"
              ></OrdersPriceInput>
            </div>
            <div class="input_block">
