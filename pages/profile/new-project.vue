    ...
    <div class="wrapper">
        ...
        <div class="portfolio">
            <div class="left_part">
                ...
                <div class="block">
                    <p>Навыки</p>
                    <UIDevInput v-model="portfolio.skills" type="text"
                        placeholder="Навыки, которые вы использовали в проекте"></UIDevInput>
                </div>
            </div>
...
async function uploadFiles() {
    ...
    formData.append("skills", portfolio.value.skills);
